...
namespace EscuelaAspNetCore.Controllers
{
    public class AsignaturaController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            ViewData["CursoNombre"] = new SelectList(_context.Cursos, "Id", "Nombre", asignatura.CursoId);
            return View(asignatura);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CursoId,Id,Nombre")] Asignatura asignatura)
        {
            // if (id != asignatura.Id)
            // {
            //     return NotFound();
